...
DQB: compare donor's 1 allele to recipient's 2 DDRDRQB alleles (1:2)
DRB and DRw: compare donor's 1 allele to recipient's DRB+DRw alleles (1:4)
DPB: if inter-loci eplets (av >= 22 or other <= 8) then compare donor's 1 allele to recipient's ALL B alleles (DQB, DRB, DRw, DPB) (1:8), else compare donor's 1 allele with recipient's DPB alleles (1:2)
DQA: compare donor's 1 allele to recipient's 2 DQA alleles (1:2)
DPA: compare donor's 1 allele to recipient's 2 DPA alleles (1:2)
