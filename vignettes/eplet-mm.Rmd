...
###*** 03/29/2021  ***###
# 1. single moleclue level report: if is.na(donor's hla) then it won't show up in the final report 
# 2. overall report: mm_cnt_tt is the total count of mismatch eplet
###*** end of 03/29/2021 ***###
