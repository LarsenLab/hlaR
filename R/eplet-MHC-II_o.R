#' @name CalEpletMHCII_o
#' @title calculate HLA class-II eplet mismatch using Matchmaker reference table and algorithm, summary report
#' @param dat_in
...
#' re <- CalEpletMHCII_o(dat_in = dat, ver = 3)
#' }
#'
...
CalEpletMHCII_o <- function(dat_in, ver = 3) {
